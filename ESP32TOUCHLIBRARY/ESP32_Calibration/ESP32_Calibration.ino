//This example can used for normal arduino boards.
//This library is an extension of the default "TouchScreen" library of arduino.
...
int XP = 12, YP = 33, XM = 15, YM = 13; //320x480 ID=0x9486
